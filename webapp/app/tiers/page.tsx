    ...
    <main className="mx-auto max-w-4xl px-4 py-12 space-y-10">
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="text-white/60">
            {[
              ...
              { label: "AI Models", free: "Gemini Flash", t1: "Gemini Flash, Grok 3, GPT-4o Mini, Claude Haiku" },
        ...
        <Card className="p-6 border-[#00D4AA]/20">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-xs text-white/50">
                <li>🧠 <strong className="text-white/70">Models:</strong> Gemini Flash + Grok 3 + GPT-4o Mini + Claude Haiku</li>
          ...
          <div className="mt-4 rounded-lg bg-[#00D4AA]/5 border border-[#00D4AA]/20 p-3">
            <p className="text-xs text-[#00D4AA]/70">
              <strong>Key advantage:</strong> 4 different AI models from different providers catch different things.
      ...
      <Card className="p-6 border-[#FFD700]/20 bg-gradient-to-r from-[#FFD700]/5 to-transparent">
        ...
        <div className="grid gap-4 sm:grid-cols-3 text-center">
          <div className="p-3">
            <div className="font-orbitron text-3xl font-bold text-white">1→4</div>
