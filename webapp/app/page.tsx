        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-10 space-y-4">
            {[
              ...
              { q: "How do I upgrade to higher tiers?", a: "Connect your Solana wallet to access Pro tier with 6 agents + adversarial debate. Higher tiers with up to 20+ agents and frontier AI models are coming soon. Free tier requires no wallet — just paste an address and scan." },
              ...
              { q: "Can my AI agent/bot use VerdictSwarm?", a: "That's the plan. We're building a B2A (Bot-to-Agent) API so any AI agent or trading bot can get swarm intelligence before every trade. Drop a SKILL.md into your OpenClaw agent, or hit the SSE API directly. One call, instant verdict. API access is coming soon — follow @VswarmAi for launch updates." },
