    ...
    <main className="mx-auto max-w-3xl px-4 py-12 space-y-10">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Link href="/community">
          <Card className="p-6 h-full transition hover:border-[#6B46C1]/40">
            <span className="text-2xl">🐝</span>
            <h2 className="text-lg font-bold text-white mt-2">Community</h2>
            <p className="text-sm text-white/50 mt-1">Join the Swarm. Graduation mission, early rewards, and why now is the time.</p>
          </Card>
        </Link>
